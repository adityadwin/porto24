  ...
  return (
    <AboutLayout>
      <div className="container flex flex-col mx-auto lg:flex-row md:flex-row lg:px-44 md:px-4">
        ...
        <div className="left px-4 lg:w-1/2 md:w-1/2">
          ...
          <p className="mt-3 mb-3 lg:text-lg md:text-sm text-justify">
          ...
          <div className="count flex flex-row space-x-8">
            <h1 className="text-3xl md:text-2xl font-semibold">
              50+
              <br />
              <span className="text-base md:text-sm font-normal">Clients</span>
            </h1>
            <h1 className="text-3xl md:text-2xl font-semibold">
              100+
              <br />
